...
Community data inevitably contain errors due to misidentifications or oversight and need correcting.
The goal of correct.community is to provide a framework for correcting these errors in a reproducible way.
